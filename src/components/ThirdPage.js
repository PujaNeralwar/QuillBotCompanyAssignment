...
const ThirdPage = () => {
    ...
    return (
        <div className='detailOuterDiv' id='roundProgress'>
            <p className='premiumHeading' style={{fontSize:"26px"}}>Write better, faster, and clearer instantly</p>
            <p className='someText' style={{fontSize:"17px"}}>QuillBot is trusted by students, professionals writers, and<br></br> business people who want to write more effectively.</p>
